...
main(Argv) :-
    ...
    digits_of(N,Temp70),
    overlapping_chunks_of_size_in(13,Temp70,Temp71),
    products_in(Temp71,Temp72),
    maximum_of(Temp72,Temp73),
    the(Temp73,Temp74),
...
% FuncType EnkiInt (FuncType (TypeName [Named "list",Any "T863"]) (TypeName [Named "list",Any "T831"]))
overlapping_chunks_of_size_in(L,List,AUTOGENERATEDFUNCTIONRESULT) :-
    (
        ...
        ;
            ...
            drop_from(1,List,Temp63),
            overlapping_chunks_of_size_in(L,Temp63,Temp64),
            prepend_to(Temp62,Temp64,Temp65),
            AUTOGENERATEDFUNCTIONRESULT = Temp65
    ).

% FuncType (TypeName [Named "list",TypeName [Named "list",EnkiInt]]) (TypeName [Named "list",Any "T880"])
products_in(List,AUTOGENERATEDFUNCTIONRESULT) :-
    (
            prepend_to(H,T,Temp66),
            List = Temp66
            ->
            product_of(H,Temp67),
            products_in(T,Temp68),
