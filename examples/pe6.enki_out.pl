...
main(Argv) :-
    answer_up_to(100,Temp126),
    the(Temp126,Temp125),
    as_text(Temp125,Temp124),
    display(Temp124).
% EnkiString
display(X) :-
    writeln(X).
...
squares_of(List,AUTOGENERATEDFUNCTIONRESULT) :-
    (
            ...
            ->
            Temp114 #= (H ^ 2),
            squares_of(T,Temp115),
            prepend_to(Temp114,Temp115,AUTOGENERATEDFUNCTIONRESULT),
            AUTOGENERATEDFUNCTIONRESULT = AUTOGENERATEDFUNCTIONRESULT
        ;
            AUTOGENERATEDFUNCTIONRESULT = empty()
    ).
...
% FuncType EnkiInt EnkiInt
answer_up_to(N,Temp122) :-
    integers_from_to(1,N,Temp118),
    squares_of(Temp118,Temp117),
    sum_of(Temp117,Temp116),
    the(Temp116,SumSquare),
    SumSquare = SumSquare,
    integers_from_to(1,N,Temp120),
    sum_of(Temp120,Temp119),
    Temp121 #= (Temp119 ^ 2),
    SquareSum = Temp121,
    Temp122 #= (SquareSum - SumSquare).