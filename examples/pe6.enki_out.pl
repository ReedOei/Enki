...
squares_of(List,AUTOGENERATEDFUNCTIONRESULT) :-
    (
            ...
            ->
            Temp116 #= (H ^ 2),
            squares_of(T,Temp117),
            prepend_to(Temp116,Temp117,AUTOGENERATEDFUNCTIONRESULT),
            AUTOGENERATEDFUNCTIONRESULT = AUTOGENERATEDFUNCTIONRESULT
        ;
            AUTOGENERATEDFUNCTIONRESULT = empty()
    ).
...
% FuncType EnkiInt EnkiInt
answer_up_to(N,Temp124) :-
    integers_from_to(1,N,Temp120),
    squares_of(Temp120,Temp119),
    sum_of(Temp119,Temp118),
    the(Temp118,SumSquare),
    SumSquare = SumSquare,
    integers_from_to(1,N,Temp122),
    sum_of(Temp122,Temp121),
    Temp123 #= (Temp121 ^ 2),
    SquareSum = Temp123,
    Temp124 #= (SquareSum - SumSquare).