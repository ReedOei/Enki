...
main(Argv) :-
    integers_from_to(1,10,Temp121),
    the(Temp121,Temp120),
    map_over(increment,Temp120,Temp119),
    sum_of(Temp119,Temp118),
    the(Temp118,Temp117),
    as_text(Temp117,Temp116),
    display(Temp116).
% EnkiString
display(X) :-
    writeln(X).
...
% FuncType (TypeName [Named "list",Any "T263"]) EnkiString
...
% FuncType (TypeName [Named "list",Any "T278"]) EnkiString
...
% FuncType (TypeName [Named "list",Any "T385"]) (FuncType (TypeName [Named "list",Any "T386"]) (TypeName [Named "list",TypeName [Named "pair",Any "T369",Any "T370"]]))
...
% FuncType (Any "T607") (FuncType (TypeName [Named "list",Any "T608"]) (TypeName [Named "list",TypeName [Named "pair",Any "T591",Any "T592"]]))
...
% FuncType (TypeName [Named "list",Any "T654"]) (FuncType (TypeName [Named "list",Any "T655"]) (TypeName [Named "list",Any "T632"]))
...
% FuncType (TypeName [Named "list",Any "T667"]) (FuncType (TypeName [Named "list",Any "T668"]) (TypeName [Named "list",Any "T669"]))
pairs_of_and(A,B,Temp52) :-
    cartesian_product_of_and(A,B,Temp52).

% FuncType EnkiInt (FuncType (TypeName [Named "list",Any "T696"]) (TypeName [Named "list",Any "T687"]))
...
% FuncType EnkiInt (FuncType (TypeName [Named "list",Any "T722"]) (TypeName [Named "list",Any "T722"]))
...
% FuncType EnkiInt (FuncType (TypeName [Named "list",Any "T772"]) (FuncType (Any "T780") (Any "T780")))
...
% FuncType EnkiInt (FuncType (TypeName [Named "list",Any "T827"]) (TypeName [Named "list",TypeName [Named "list",Any "T800"]]))
...
% FuncType EnkiInt (FuncType (TypeName [Named "list",Any "T834"]) (TypeName [Named "list",TypeName [Named "list",Any "T835"]]))
chunks_of_length_in(L,List,Temp62) :-
    chunks_of_size_in(L,List,Temp62).

% RuleType (TypeName [Named "list",Any "T848"]) (Any "T848")
...
% FuncType (Any "T882") (FuncType (TypeName [Named "list",Any "T882"]) (TypeName [Named "list",Any "T882"]))
...
% FuncType (Any "T896") (FuncType (Any "T897") (TypeName [Named "mapping",Any "T896",Any "T897"]))
...
% FuncType (TypeName [Named "mapping",Any "T919",Any "T920"]) (Any "T919")
key_in(AUTOGENARG3,K) :-
    maps_to(K,V,AUTOGENARG3),
    AUTOGENARG3 = AUTOGENARG3.

% FuncType (TypeName [Named "mapping",Any "T930",Any "T931"]) (Any "T931")
value_in(AUTOGENARG3,V) :-
    maps_to(K,V,AUTOGENARG3),
    AUTOGENARG3 = AUTOGENARG3.

% FuncType (TypeName [Named "mapping",EnkiInt,Any "T943"]) (FuncType (TypeName [Named "mapping",EnkiInt,Any "T952"]) (TypeName [Named "ordering"]))
...
% FuncType (TypeName [Named "mapping",Any "T965",EnkiInt]) (FuncType (TypeName [Named "mapping",Any "T974",EnkiInt]) (TypeName [Named "ordering"]))
compare_values_to(AUTOGENARG3,AUTOGENARG5,Temp67) :-
    AUTOGENARG3 = pipe_dash_gt_(K1,V1),
    AUTOGENARG5 = pipe_dash_gt_(K2,V2),
    compare_to(V1,V2,Temp67).

% FuncType (Any "T994") (FuncType (TypeName [Named "list",TypeName [Named "mapping",Any "T994",Any "T995"]]) (Any "T995"))
get_key_from(Key,Map,V) :-
    contains(Map,pipe_dash_gt_(Key,V)).

% FuncType (Any "T1011") (FuncType (Any "T1012") (FuncType (TypeName [Named "list",TypeName [Named "mapping",Any "T1011",Any "T1012"]]) (TypeName [Named "list",TypeName [Named "mapping",Any "T1011",Any "T1012"]])))
insert_into(K,V,Map,cons(pipe_dash_gt_(K,V),Map)).

% FuncType (Any "T1028") (FuncType (TypeName [Named "list",TypeName [Named "mapping",Any "T1028",Any "T1029"]]) (TypeName [Named "list",TypeName [Named "mapping",Any "T1028",Any "T1029"]]))
remove_key_from(Key,Map,Temp72) :-
    remove_from(pipe_dash_gt_(Key,V),Map,Temp72).

% FuncType (Any "T1063") (FuncType (TypeName [Named "list",TypeName [Named "mapping",Any "T1063",EnkiInt]]) (TypeName [Named "list",TypeName [Named "mapping",Any "T1063",EnkiInt]]))
increment_key_in(Key,Map,Temp74) :-
    Temp77 #= (V + 1),
    remove_from(pipe_dash_gt_(Key,V),Map,Temp75),
    insert_into(Key,Temp77,Temp75,Temp74).

% FuncType (TypeName [Named "mapping",EnkiInt,Any "T1106"]) (FuncType (TypeName [Named "list",TypeName [Named "mapping",EnkiInt,Any "T1107"]]) (TypeName [Named "mapping",EnkiInt,Any "T1106"]))
...
% FuncType (TypeName [Named "mapping",EnkiInt,Any "T1181"]) (FuncType (TypeName [Named "list",TypeName [Named "mapping",EnkiInt,Any "T1182"]]) (TypeName [Named "mapping",EnkiInt,Any "T1181"]))
...
% FuncType (TypeName [Named "list",TypeName [Named "mapping",EnkiInt,Any "T1211"]]) (TypeName [Named "maybe",TypeName [Named "mapping",EnkiInt,Any "T1211"]])
...
% FuncType (TypeName [Named "mapping",Any "T1256",EnkiInt]) (FuncType (TypeName [Named "list",TypeName [Named "mapping",Any "T1257",EnkiInt]]) (TypeName [Named "mapping",Any "T1256",EnkiInt]))
...
% FuncType (TypeName [Named "list",TypeName [Named "mapping",Any "T1286",EnkiInt]]) (TypeName [Named "maybe",TypeName [Named "mapping",Any "T1286",EnkiInt]])
...
% FuncType (TypeName [Named "mapping",Any "T1331",EnkiInt]) (FuncType (TypeName [Named "list",TypeName [Named "mapping",Any "T1332",EnkiInt]]) (TypeName [Named "mapping",Any "T1331",EnkiInt]))
...
% FuncType (TypeName [Named "list",TypeName [Named "mapping",Any "T1361",EnkiInt]]) (TypeName [Named "maybe",TypeName [Named "mapping",Any "T1361",EnkiInt]])
...
% FuncType (Any "T1371") (TypeName [Named "list",Any "T1371"])
singleton(X,cons(X,empty())).

% FuncType (TypeName [Named "list",Any "T1408"]) (TypeName [Named "list",Any "T1390"])
...
% FuncType (TypeName [Named "list",Any "T1444"]) (TypeName [Named "maybe",Any "T1444"])
...
% RuleType (TypeName [Named "list",Any "T1463"]) (Any "T1463")
...
% FuncType (FuncType (Any "T1721") (Any "T1722")) (FuncType (TypeName [Named "list",Any "T1721"]) (TypeName [Named "list",Any "T1722"]))
map_over(F,Xs,Temp114) :-
    map_built_in(F,Xs,Temp114).