...
main(Args) :-
    digit_numbers(2,Temp10),
    digit_numbers(2,Temp16),
    pairs_of_and(Temp10,Temp16,Temp8),
    multiply_each_pair_in(Temp8,Temp6),
    palindrome_numbers_in(Temp6,Temp4),
...
multiply_each_pair_in(List,AUTOGENERATEDFUNCTIONRESULT) :-
    (
    List = cons(pair_and(A,B),T) -> 
    Temp19 #= A * B,
    multiply_each_pair_in(T,Temp24),
