...
main(Argv) :-
    fib_seq_up_to(4000000,Temp121),
    multiples_of_in(2,Temp121,Temp120),
...
fib_nums(A,B,Limit,AUTOGENERATEDFUNCTIONRESULT) :-
    (
        ...
        ;
            Temp115 #= (A + B),
            fib_nums(B,Temp115,Limit,Temp114),
            prepend_to(A,Temp114,AUTOGENERATEDFUNCTIONRESULT),
            AUTOGENERATEDFUNCTIONRESULT = AUTOGENERATEDFUNCTIONRESULT
    ).

% FuncType EnkiInt (TypeName [Named "list",EnkiInt])
fib_seq_up_to(N,Temp116) :-
    fib_nums(0,1,N,Temp116).