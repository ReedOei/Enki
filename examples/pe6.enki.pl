...
answer_up_to(N,Temp33) :-
    integers_from_to(1,N,Temp6),
    squares_of(Temp6,Temp4),
    sum_of(Temp4,Temp2),
    SumSquare = Temp2,
    integers_from_to(1,N,Temp22),
    sum_of(Temp22,Temp20),
    Temp19 #= Temp20 ^ 2,
    SquareSum = Temp19,
    Temp33 #= SquareSum - SumSquare.
