...
main(Argv) :-
    answer_less_than(999,Temp76),
    as_text(Temp76,Temp77),
    display(Temp77).
% EnkiString
display(X) :-
    writeln(X).
...
% FuncType EnkiInt EnkiInt
answer_less_than(N,Temp75) :-
    range_to(1,N,Temp65),
    multiples_of_in(3,Temp65,Temp66),
    ThreeMult = Temp66,
    range_to(1,N,Temp67),
    multiples_of_in(5,Temp67,Temp68),
    FiveMult = Temp68,
    range_to(1,N,Temp69),
    multiples_of_in(15,Temp69,Temp70),
    FifteenMult = Temp70,
    sum(ThreeMult,Temp71),
    sum(FiveMult,Temp72),
    Temp73 #= (Temp71 + Temp72),
    sum(FifteenMult,Temp74),
