...
main(Argv) :-
    answer_less_than(999,Temp73),
    as_text(Temp73,Temp74),
    display(Temp74).
% EnkiString
display(X) :-
    writeln(X).
...
% FuncType EnkiInt EnkiInt
answer_less_than(N,Temp72) :-
    range_to(1,N,Temp62),
    multiples_of_in(3,Temp62,Temp63),
    ThreeMult = Temp63,
    range_to(1,N,Temp64),
    multiples_of_in(5,Temp64,Temp65),
    FiveMult = Temp65,
    range_to(1,N,Temp66),
    multiples_of_in(15,Temp66,Temp67),
    FifteenMult = Temp67,
    sum_of(ThreeMult,Temp68),
    sum_of(FiveMult,Temp69),
    Temp70 #= (Temp68 + Temp69),
    sum_of(FifteenMult,Temp71),
