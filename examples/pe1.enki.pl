...
main(Argv) :-
    answer_less_than(999,Temp106),
    as_text(Temp106,Temp105),
    display(Temp105).
% EnkiString
display(X) :-
    writeln(X).
...
% FuncType EnkiInt EnkiInt
answer_less_than(N,Temp103) :-
    range_to(1,N,Temp96),
    multiples_of_in(3,Temp96,ThreeMult),
    ThreeMult = ThreeMult,
    range_to(1,N,Temp97),
    multiples_of_in(5,Temp97,FiveMult),
    FiveMult = FiveMult,
    range_to(1,N,Temp98),
    multiples_of_in(15,Temp98,FifteenMult),
    FifteenMult = FifteenMult,
    sum_of(ThreeMult,Temp99),
    sum_of(FiveMult,Temp100),
    Temp101 #= (Temp99 + Temp100),
    sum_of(FifteenMult,Temp102),
