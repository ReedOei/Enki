...
main(Argv) :-
    fib_seq_up_to(4000000,Temp69),
    multiples_of_in(2,Temp69,Temp70),
    sum_of(Temp70,Temp71),
    as_text(Temp71,Temp72),
    display(Temp72).
% EnkiString
display(X) :-
    writeln(X).
...
% FuncType (TypeName [Named "list",Any "T35"]) EnkiInt
...
% FuncType (Any "T48") (FuncType (TypeName [Named "list",Any "T48"]) (TypeName [Named "list",Any "T48"]))
construct(Head,Full,Tail) :-
    Full = cons(Head,Tail).

% FuncType (TypeName [Named "list",Any "T75"]) (FuncType (TypeName [Named "list",Any "T75"]) (TypeName [Named "list",Any "T75"]))
...
% FuncType (TypeName [Named "list",Any "T87"]) (FuncType (TypeName [Named "list",Any "T87"]) (TypeName [Named "list",Any "T87"]))
concat_with(A,B,Temp9) :-
    concat(A,B,Temp9).

% FuncType (TypeName [Named "list",TypeName [Named "list",Any "T111"]]) (TypeName [Named "list",Any "T111"])
...
% FuncType (TypeName [Named "list",Any "T142"]) (FuncType (TypeName [Named "list",Any "T142"]) (TypeName [Named "list",Any "T142"]))
...
% FuncType (TypeName [Named "list",Any "T151"]) (TypeName [Named "list",Any "T151"])
...
% FuncType EnkiInt (FuncType (TypeName [Named "list",EnkiInt]) (TypeName [Named "list",Any "T201"]))
...
% FuncType EnkiInt (FuncType EnkiInt (TypeName [Named "list",Any "T276"]))
...
% FuncType EnkiInt (FuncType EnkiInt (TypeName [Named "list",Any "T297"]))
range_from_to(Low,High,Temp28) :-
    range_to(Low,High,Temp28).

% FuncType EnkiInt (FuncType EnkiInt (TypeName [Named "list",Any "T303"]))
integers_from_to(Low,High,Temp29) :-
    range_to(Low,High,Temp29).

% FuncType (TypeName [Named "list",EnkiInt]) (TypeName [Named "list",Any "T319"])
...
% FuncType (TypeName [Named "list",Any "T375"]) (FuncType (TypeName [Named "list",Any "T376"]) (TypeName [Named "list",Any "T357"]))
...
% FuncType EnkiInt (TypeName [Named "list",Any "T504"])
...
% FuncType EnkiInt (TypeName [Named "list",Any "T534"])
...
% FuncType (Any "T599") (FuncType (TypeName [Named "list",Any "T600"]) (TypeName [Named "list",Any "T581"]))
...
% FuncType (TypeName [Named "list",Any "T644"]) (FuncType (TypeName [Named "list",Any "T645"]) (TypeName [Named "list",Any "T623"]))
...
% FuncType (TypeName [Named "list",Any "T657"]) (FuncType (TypeName [Named "list",Any "T658"]) (TypeName [Named "list",Any "T659"]))
pairs_of_and(A,B,Temp51) :-
    cartesian_product_of_and(A,B,Temp51).

% FuncType EnkiInt (FuncType (TypeName [Named "list",Any "T686"]) (TypeName [Named "list",Any "T686"]))
...
% FuncType EnkiInt (FuncType (TypeName [Named "list",Any "T712"]) (TypeName [Named "list",Any "T712"]))
...
% FuncType EnkiInt (FuncType (TypeName [Named "list",Any "T766"]) (FuncType (Any "T774") (Any "T774")))
...
% FuncType EnkiInt (FuncType (TypeName [Named "list",Any "T819"]) (TypeName [Named "list",Any "T787"]))
...
% FuncType EnkiInt (FuncType (TypeName [Named "list",Any "T826"]) (TypeName [Named "list",Any "T827"]))
chunks_of_length_in(L,List,Temp64) :-
    chunks_of_size_in(L,List,Temp64).

% FuncType (Any "T833") (FuncType (TypeName [Named "list",Any "T833"]) (TypeName [Named "list",Any "T833"]))
prepend_to(Head,Tail,cons(Head,Tail)).

% FuncType EnkiInt (FuncType EnkiInt (FuncType EnkiInt (TypeName [Named "list",Any "T844"])))
fib_seq(A,B,Limit,AUTOGENERATEDFUNCTIONRESULT) :-
    (
        ...
        ;
            Temp65 #= (A + B),
            fib_seq(B,Temp65,Limit,Temp66),
            prepend_to(A,Temp66,Temp67),
            AUTOGENERATEDFUNCTIONRESULT = Temp67
    ).

% FuncType EnkiInt (TypeName [Named "list",Any "T865"])
fib_seq_up_to(N,Temp68) :-
    fib_seq(0,1,N,Temp68).